...
const artMap = {
  ...
  'compare-numbers': NumberOrder,
  'missing-number': CountObjects,
  'trace-lines-basic': TraceLines,
  'trace-geometric-shapes': TraceGeometry,
  'find-color': ColorFind,
  'listen-colors': ListenColors,
  'color-objects': ColorFind,
  'listen-more-colors': ListenColors,
  'color-challenge': ColorFind,
  'identify-shapes': IdentifyShapes,
  patterns: Patterns,
  'shapes-around-us': IdentifyShapes,
  'animal-sounds': AnimalSounds,
  'first-words': FirstWords,
  'initial-sounds': ListenVowels,
  'match-words': FirstWords,
  'listen-words-advanced': AnimalSounds,
}
